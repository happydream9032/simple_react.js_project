...
const SigninComponent = ({}) => {
  ...
  const responseGoogle = async (response: any) => {
    try {
      ...
      const apiUrl = process.env.NEXT_PUBLIC_API_BASE_URL + "/user/googlelogin";
      axios
        ...
        .catch((error) => {
          toast.error("Login Failure", { position: "top-right" });
          // Handle the error
        });
    } catch (error) {
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                <GoogleLogin
                  ...
                  isSignedIn={true}
                  className="mb-6 flex w-full items-center justify-center rounded-md"
                />
                {/* <button
                  className="mb-6 flex w-full items-center justify-center rounded-md bg-white p-3 text-base font-medium text-black shadow-one hover:text-primary dark:bg-[#242B51] dark:text-white dark:text-body-color dark:shadow-signUp dark:hover:text-white"
                  onClick={() => googlelogin()}
                >
                  <span className="mr-3">
                    <svg
                ...
                <div className="mb-8">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-transparent py-3 px-6 text-base text-black placeholder-body-color shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-[#242B51] dark:text-white dark:shadow-signUp"
                    onChange={(password) => {
                      handlePassWordInput(password.currentTarget.value);
                    }}
                  />
                </div>
