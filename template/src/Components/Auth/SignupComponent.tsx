...
const SignupComponent = () => {
  ...
  useEffect(() => {
    //start();
    console.log("client id is", process.env.NEXT_PUBLIC_CLIENT_ID);
  }, []);
  ...
  const onSignUpSubmit = async () => {
    try {
      ...
      const response = await axios.post(apiUrl, data); // If using Axios
              ...
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                <div className="mb-8">
                  ...
                  <input
                    ...
                    onChange={(username) => {
                      handleFirstNameInput(username.currentTarget.value);
                    }}
                  />
                </div>
                <div className="mb-8">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-transparent py-3 px-6 text-base text-black placeholder-body-color shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-[#242B51] dark:text-white dark:shadow-signUp"
                    onChange={(username) => {
                      handleLastNameInput(username.currentTarget.value);
                    }}
                  />
                </div>
                <div className="mb-8">
